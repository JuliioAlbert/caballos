...
nameFileCode = "caballos.py" # Nombre del archivo (py o js) que contiene el codigo que queremos convertir
nameFileConversion = "caballos.js" # Nombre del archivo que contendra el codigo convertido
